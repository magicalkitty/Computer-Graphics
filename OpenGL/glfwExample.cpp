...
int main(void)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, texture.width, texture.height, 0, GL_RGB, GL_FLOAT, texture.data.data());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 diffuseColor(94.0/255.0f, 235.0/255.0f, 52.0/255.0f);
